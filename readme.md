...
This will create an executable jar file **liberty-dev-tools.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/liberty-dev-tools.jar
